...
namespace DataAccess.Migrations
{
    ...
    [Migration("20220611140143_MigCreateV4_1")]
    partial class MigCreateV4_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryKit", b =>
                {
                    b.Property<int>("CategoriesId")
                        .HasColumnType("integer")
                        .HasColumnName("categories_id");
                    ...
                    b.HasKey("CategoriesId", "KitsId")
                        .HasName("pk_category_kit");

                    b.HasIndex("KitsId")
                        .HasDatabaseName("ix_category_kit_kits_id");

                    b.ToTable("category_kit", (string)null);
                });
            ...
            modelBuilder.Entity("CategoryKit", b =>
                {
                    b.HasOne("Entities.Concrete.Infos.Category", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_category_kit_categories_categories_id");
                    ...
                    b.HasOne("Entities.Concrete.Kit", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_category_kit_kits_kits_id");
                });
